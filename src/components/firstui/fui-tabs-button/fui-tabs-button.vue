  ...
  >
    <view class="fui-scroll__view" :class="{ 'fui-tabs__full': !alignLeft }">
      <view
        ...
        :class="{
          'fui-tabs__full': !alignLeft,
          'fui-tabs__active': tabIndex === index,
        }"
        :id="tab.fui_s_id"
        @tap="switchTab(index)"
      >
...
.fui-tabs__active .fui-tabs__text {
  color: #fff !important;
}
/* #ifndef APP-NVUE */
::-webkit-scrollbar {
...
/* #ifndef APP-NVUE */
.fui-tabs__selected-color {
  color: var(--fui-color-primary, #6D68ED) !important;
}

.fui-tabs__text-color {
  color: var(--fui-color-subtitle, #ffffff) !important;
}

.fui-tabs__slider-color {
  background: var(--fui-color-primary, #6D68ED) !important;
}

.fui-tabs__badge-color {
  background: var(--fui-color-danger, #6D68ED) !important;
}
