<template>
	...
	<view class="fui-lottie__wrap">
		<!-- #ifdef APP-VUE || H5 -->
		<view ref="lottieRef" :id="'lottieRef'+options.idd" :prop="options" :change:prop="handler.changeProp" :action="actionVal"
			...
			init(vals) {
				...
				this.$nextTick(() => {
					this.ani = lottie.loadAnimation({
						// #ifndef H5
						container: document.getElementById('lottieRef'+vals.idd),
						// #endif
						// #ifdef H5
