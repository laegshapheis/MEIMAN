<template>
	...
	<view :style="getStyle">
		<view class="fui-nav__bar"
			...
			:style="{background:background,'border-bottom-color':lineColor,paddingLeft:padding+'rpx',paddingRight:padding+'rpx',zIndex:zIndex}">
			...
			<view class="fui-nav__header" v-if="!custom">
				...
				<view class="fui-nav__title" v-if="title" @tap="titleClick">
					<text class="fui-nav__title-text"
						:style="{fontSize:size+'rpx',color:color,fontWeight:fontWeight}">{{title}}</text>
				</view>
