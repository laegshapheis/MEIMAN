<template>
  <layout navTitle="集卡记录" bgType="bg-main">
    <view class="px-[32rpx]">
      <!-- 兑换记录列表 -->
      <view class="exchange-list">
        <wk-stroke-bg v-for="(item, index) in exchangeRecords" :key="index" class="flex flex-row items-center mb-[24rpx]">
...
export default {
  ...
  methods: {
    ...
    getExchangeRecords() {
      this.$requestApi({
        url: "/api/v2/fucards/fucardrecord",
        method: "post",
        data: {
          page: this.page,
        },
