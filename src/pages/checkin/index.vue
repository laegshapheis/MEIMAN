      ...
      <view class="qd-bg pt-[48rpx] relative z-20">
        ...
        >
          ...
          <view class="mt-[16rpx] w-full">
            ...
            <wk-button
              v-else
              style="background: rgba(0, 0, 0, 0.20);border-radius: 48rpx;"
              backgroundColor="transparent"
      ...
      >
        ...
        <scroll-view :scroll-y="true">
          <view class="grid grid-cols-1 gap-[16rpx]">
            <view
              v-for="(item, index) in data.dayarr"
              :key="index"
    ...
    >
      ...
      >
        <view class="left-0 w-full flex flex-row justify-center">
          <image
            class="w-[160rpx] h-[160rpx] absolute top-[-100rpx]"
            src="/static/images/index/checkin_coin.png"
            mode="widthFix"
          ></image>
        </view>
        <view
