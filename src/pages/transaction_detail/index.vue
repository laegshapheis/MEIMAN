    ...
    >
      <template v-slot:navRight>
        <view class="flex flex-row w-full items-center justify-end">
          ...
          >
          <view>
              <view v-if="time_date == 0" class="flex items-center justify-center w-[64rpx] h-[64rpx] bg-white/10 rounded-full">  
                <image
      ...
      >
        ...
        <view class="flex flex-col">
          ...
          >
            <view class="flex flex-col">
              <text class="text-xl font-semibold break-all">{{
              ...
              <view class="flex flex-row justify-between items-center mt-[16rpx]">
                ...
                <text :class="['text-2xl font-semibold', item.moneylog_status == '-' ? 'text-neutral-error' : 'text-neutral-theme']">{{
            ...
            >
              ...
              >
                <view
                  ...
                  :key="`ext-clo-${extItem.id}`"
                >
                  <text class="text-lg font-semibold text-neutral-theme">{{ extItem.value }}</text>
