<template>
  ...
  >
    ...
    >
      <!-- start 顶部汇总信息 -->
      <view
        class="flex flex-row justify-around rounded-[24rpx] w-full mx-auto h-[186rpx] bg-card3"
      >
        <view class="flex flex-col items-center justify-center">
          <text class="text-base text-white"
            >转出成功金额({{ symbolStore.code }})</text
          >
          <text
            class="text-2xl font-bold leading-6 text-[40rpx] mt-[16rpx] text-white"
            >{{ chenggong }}</text
          >
        </view>
